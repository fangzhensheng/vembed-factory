#!/bin/bash
# DINOv2 — Image-to-Image retrieval on SOP dataset
...
# MODEL_NAME="facebook/dinov2-base"  # Or 'dinov2-small', 'dinov2-large'
MODEL_NAME="facebook/dinov2-small"
OUTPUT_DIR="output_sop_dinov2_i2i"
